...
#  define LIBINPUT_NAME   "/dev/input/event10"        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
...
#  define EVDEV_NAME   "/dev/input/event9"        /*You can use the "evtest" Linux tool to get the list of devices and test them*/
...
#    define EVDEV_HOR_MAX      32767               /*"evtest" Linux tool can help to get the correct calibraion values>*/
